...
Если возникла какая-либо проблема, ошибка, баг обратитесь в чат поддержки: {sys['help_place']}, там Вам помогут с сложившейся ситуацией. Если Вы достаточно продвинутый пользователь, можете открыть Issue на [github-странице бота]({sys['github_issues']}).
